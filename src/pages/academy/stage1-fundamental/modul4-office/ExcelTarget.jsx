    ...
    <div className="min-h-screen bg-gray-950 text-gray-300 font-mono p-6 md:p-12">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div 
          ...
          className="flex items-center gap-4 mb-10 border-b border-emerald-900/30 pb-6"
        >
          <div className="p-3 bg-emerald-500/10 rounded-lg border border-emerald-500/50">
            <Database className="w-8 h-8 text-emerald-500" />
          </div>
          <div>
            <h1 className="text-sm text-emerald-500 tracking-[0.3em] uppercase font-black">Office Security Phase_03</h1>
            <h2 className="text-3xl font-bold text-white tracking-tighter italic uppercase">EXCEL SEBAGAI TARGET</h2>
          </div>
        </motion.div>
