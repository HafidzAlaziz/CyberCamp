...
import { ChevronLeft, Home, Trophy, CheckCircle2, Zap, Shield, Layers, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-950 text-gray-300 font-mono p-6 md:p-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gray-900/50 border border-cyan-500/30 rounded-2xl p-8 md:p-16 shadow-2xl relative overflow-hidden text-center">
          ...
          <div className="absolute bottom-0 right-0 w-64 h-64 bg-purple-500/5 blur-[100px] pointer-events-none"></div>
          ...
          >
             <h1 className="text-4xl md:text-6xl font-black text-white italic tracking-tighter uppercase grayscale-0">
               OSI MODEL: <span className="text-cyan-400 text-glow-cyan">DEMYSTIFIED</span>
             </h1>
             
             <div className="max-w-2xl mx-auto space-y-4">
                <p className="text-gray-400 leading-relaxed text-sm md:text-base">
                   Gokil, Bos! Lo udah berhasil nge-bongkar 7 tata krama data di internet. Dari isi pesan (Layer 7) sampe kurir ngegas motor (Layer 1). Lo paham ini, lo udah menang selangkah dari admin jaringan amatir!
                </p>
                <div className="flex flex-wrap justify-center gap-4 py-6">
                   ...
                   <div className="px-4 py-2 bg-purple-500/10 border border-purple-500/30 rounded-sm text-[10px] font-black text-purple-400 uppercase tracking-widest">
                      Protocol Expert
                   </div>
                   <div className="px-4 py-2 bg-emerald-500/10 border border-emerald-500/30 rounded-sm text-[10px] font-black text-emerald-400 uppercase tracking-widest">
                      Flow Analysis: OK
                   </div>
                </div>
             </div>
          ...
          >
             ...
             >
               <ChevronLeft className="w-5 h-5 group-hover:-translate-x-1 transition-transform" /> RE-WATCH LOWER LAYERS
             </Link>
