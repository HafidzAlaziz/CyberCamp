...
const IndexCryptography = () => {
  ...
  const difficulties = [
    {
      ...
      label: 'MUDAH',
      sub: 'EASY',
      desc: 'Eksploitasi web dasar: Cookie theft, SQL Injection, XSS, Path Traversal, dan lainnya.',
      levels: mudahTotal,
      ...
      path: '/ctf-arena/cryptography/mudah'
    },
    {
      key: 'menengah',
      label: 'MENENGAH',
      sub: 'MEDIUM',
      desc: 'Serangan tingkat lanjut: JWT Forgery, SSRF, GraphQL Injection, dan OAuth Bypass.',
      levels: 0,
      completed: 0,
      isLocked: false,
      isComingSoon: true,
      ...
      bg: 'bg-yellow-500/10',
      lineColor: '#facc15',
      icon: <ShieldAlert className="w-10 h-10 text-yellow-400 mb-3" />,
      path: null
    },
    {
      key: 'sulit',
      label: 'SULIT',
      sub: 'HARD',
      desc: 'Teknik red-team nyata: RCE, Deserialization, Prototype Pollution, dan Zero-Day chains.',
      levels: 0,
      completed: 0,
      isLocked: true,
      isComingSoon: true,
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white font-mono overflow-hidden relative flex flex-col crypto-page-theme">
      {/* Background */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-0 w-[40%] h-[40%] bg-yellow-500/5 blur-[120px] rounded-full" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-10 flex flex-col flex-1 w-full">
        ...
        <header className="flex items-center gap-5 mb-16">
          ...
          >
            <ChevronLeft className="w-5 h-5 text-gray-400 group-hover:text-yellow-400 group-hover:-translate-x-0.5 transition-all" />
          </button>
          <div className="h-10 w-px bg-white/10" />
          <div>
            <div className="flex items-center gap-2 mb-1">
              <div className="w-1.5 h-1.5 bg-yellow-500 rounded-full animate-pulse" />
              <span className="text-[9px] uppercase font-black tracking-[0.3em] text-yellow-500/60">MODE: PILIHAN // WEB EXPLOITATION</span>
            </div>
            <h1 className="text-2xl font-black italic tracking-tighter uppercase text-white leading-none">
              PILIH <span className="text-yellow-400">TINGKAT KESULITAN</span>
            </h1>
          </div>
        </header>
        ...
        <footer className="mt-12 flex justify-between items-center text-[9px] text-white/10 font-black border-t border-white/5 pt-6">
          <div className="flex items-center gap-2">
            ...
            <span className="uppercase tracking-[0.2em] italic">Node: CRYPTOGRAPHYATION // Grid: X-772</span>
          </div>
...
export default IndexCryptography;
