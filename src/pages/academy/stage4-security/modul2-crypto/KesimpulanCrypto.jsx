...
import { Trophy, ShieldCheck, ChevronLeft, LayoutGrid, Award, Lock, Cpu, Globe } from 'lucide-react';

const KesimpulanCrypto = () => {
  return (
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center min-h-[60vh]">
          ...
          >
            <div>
              ...
              <p className="text-gray-400 leading-relaxed text-base italic">
                Mantap! Lo udah paham gimana dunia cyber ngelindungi datanya. Kriptografi bukan cuma buat mata-mata, tapi buat semua orang yang gak mau privasinya diinjek-injek.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="flex items-start gap-4 group">
                 ...
                 <div>
                    <h4 className="text-white font-black text-xs uppercase italic tracking-widest mb-1">ENKRIPSI</h4>
                    <p className="text-[10px] text-gray-500 leading-relaxed uppercase font-black">Buat nyembunyiin pesan pas lagi dikirim (Symmetric/Asymmetric).</p>
                 </div>
              </div>
              <div className="flex items-start gap-4 group">
                 ...
                 <div>
                    <h4 className="text-white font-black text-xs uppercase italic tracking-widest mb-1">HASHING</h4>
                    <p className="text-[10px] text-gray-500 leading-relaxed uppercase font-black">Proses satu arah buat nyimpen password & ngecek keaslian file (Integrity).</p>
              </div>
            </div>
            <div className="flex items-start gap-4 group">
                 ...
                 <div>
                    <h4 className="text-white font-black text-xs uppercase italic tracking-widest mb-1">HTTPS</h4>
                    <p className="text-[10px] text-gray-500 leading-relaxed uppercase font-black">Aplikasi nyata gabungan enkripsi & hashing buat jagain internet.</p>
                 </div>
              </div>
            </div>
          ...
          <div className="flex justify-center items-center">
            ...
            >
              ...
              <div className="bg-gray-900 w-64 h-64 rounded-full border-4 border-cyan-500 flex flex-col items-center justify-center p-8 relative shadow-[0_0_50px_rgba(6,182,212,0.3)]">
                 <div className="absolute inset-2 border border-cyan-500/20 rounded-full border-dashed animate-spin" style={{ animationDuration: '12s' }} />
                 
                 <Award className="w-24 h-24 text-cyan-500 mb-4" />
                 <h3 className="text-white font-black text-center text-xl italic leading-tight uppercase tracking-tighter">
                   CODEBREAKER <br/>
                   <span className="text-cyan-500 text-sm tracking-[0.2em]">UNLOCKED</span>
                 </h3>
        ...
        <div className="flex justify-between items-center mt-12 bg-gray-900 px-8 py-6 rounded-sm border-l-8 border-emerald-500 shadow-2xl">
          ...
          <Link 
            ...
            className="flex items-center gap-4 bg-emerald-600 hover:bg-white text-white hover:text-black px-8 py-4 text-xs font-black transition-all group rounded-sm skew-x-[-12deg]"
          >
...
export default KesimpulanCrypto;
