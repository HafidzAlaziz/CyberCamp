                  ...
                  <form onSubmit={submitFlag} className="flex flex-col md:flex-row gap-4 relative z-10">
                     <div className="relative flex-1">
                        <input
                           ...
                           className={`w-full bg-black/60 border ${status === 'wrong' ? 'border-red-500 shadow-[0_0_15px_#ef4444]' : 'border-cyan-500/30 focus:border-cyan-500'} text-cyan-100 rounded-xl py-4 px-6 text-xs font-mono focus:outline-none transition-all tracking-widest placeholder:text-gray-700 shadow-[inset_0_2px_10px_rgba(0,0,0,0.5)]`}
                        />
                     </div>
                     <button 
                        type="submit" 
